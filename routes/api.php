...
Route::controller(MateriController::class)->group(function () {
    ...
    Route::get('materiMapelByID/{id}', 'materiSyncMataPelajaranByID');
...
Route::controller(ProgressUjianController::class)->group(function () {
    ...
    Route::get('progressujianByIDUjian/{id}', 'progressUjianSyncUjianByUjianID');
...
Route::controller(SoalController::class)->group(function () {
    ...
    Route::get('soalUjianByID/{id}', 'soalSyncByIDUjian');
