...
<div id="skeleton-loader" class="w-[70%] bg-white rounded-lg shadow p-4 md:p-6">
    <div class="skeleton bg-gray-300 bg-opacity-50 animate-pulse h-10 w-1/2 mb-4"></div>
    <div class="skeleton bg-gray-300 bg-opacity-50 animate-pulse h-5 w-1/4 mb-4"></div>
    <div class="skeleton bg-gray-300 bg-opacity-50 animate-pulse h-52 w-full mb-4"></div>
    <div class="skeleton bg-gray-300 bg-opacity-50 animate-pulse h-5 w-1/5"></div>
</div>

<div id="main-content" class="w-[65%] bg-white rounded-lg shadow p-4 md:p-6 hidden">
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t= justify-between">
      <div class="flex justify-between items-center pt-5">
        ...
        <div id="lastDaysdropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
            <ul class="py-2 text-sm text-gray-700 -200" aria-labelledby="dropdownDefaultButton">
              <li>
