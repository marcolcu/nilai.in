...
<div class="mb-10 flex justify-between items-center">
    <h1 class="font-bold text-2xl">List Materi</h1>
...
<div id="kelas-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5 relative" id="addMateri">
                <div
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" id="konten" name="konten"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Materi" required />
                    </div>
                    <div class="col-span-2">
                        <label for="tipe" class="block mb-2 text-sm font-medium text-gray-900 ">Tipe Materi</label>
...
<div id="kursus-edit-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5 relative" id="editMateri">
                <div
                    class="loading-spinner hidden absolute inset-0 flex justify-center items-center bg-white bg-opacity-75 z-10">
                    <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                        viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <div class="alert-kursus hidden flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                    ...
                    <div class="col-span-2">
                        <label for="edit-judul" class="block mb-2 text-sm font-medium text-gray-900">Judul</label>
                        <input type="text" id="edit-judul" name="judul"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="John" required />
                    </div>
                    <div class="col-span-2">
                        <label for="edit-konten" class="block mb-2 text-sm font-medium text-gray-900 ">Konten</label>
                        <input type="text" id="edit-konten" name="konten"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Materi" required />
                    </div>
                    <div class="col-span-2">
                        <label for="edit-tipe" class="block mb-2 text-sm font-medium text-gray-900 ">Tipe Materi</label>
                    ...
                    <div class="col-span-2">
                        <label for="edit-IDMataPelajaran" class="block mb-2 text-sm font-medium text-gray-900 ">Mata
                            Pelajaran</label>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah kamu yakin ingin menghapus materi ini?
                </h3>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.save', function(e) {
            ...
            $('#addMateri').find('.form-control').each(function() {
        ...
        $(document).on('click', '.update', function(e) {
            ...
            $('#editMateri').find('.form-control').each(function() {
                const inputType = $(this).attr('type');
                const inputValue = $(this).val();
                const inputName = $(this).attr('name');
        ...
        function openCreateModal() {
            $('#addMateri').find('.form-control').prop('disabled', true);
            $('.loading-spinner').removeClass('hidden');
            select_api('#IDMataPelajaran', '#addMateri');
        }
        ...
        function openEditModal(id) {
            $('#editMateri').find('.form-control').prop('disabled', true);
            $('.loading-spinner').removeClass('hidden');
            $('.btn-close-edit').click();
            $.ajax({
                ...
                dataType: "json",
                success: function(response) {
                    let data = response["Materi: "].IDMataPelajaran;
                    $('#editMateri').find('.form-control').each(function() {
                        const inputName = $(this).attr('name');
                        const inputValue = response["Materi: "][inputName];
                        
                        $("#" + $(this).attr('id')).val(inputValue);
                    });

                    select_api('#edit-IDMataPelajaran', '#editMateri', data);
                },
                error: function(errors) {
                    console.error(errors);
