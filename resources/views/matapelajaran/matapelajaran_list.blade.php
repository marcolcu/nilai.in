        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 relative" id="addMapel">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="IDKelas" class="block mb-2 text-sm font-medium text-gray-900 ">Kelas</label>
        ...
        function select_api(id, place, selectedId = null) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    selectElement.append('<option value="" selected>Pilih Tingkat Kelas</option>');

                    // Populate new options
                    response["kelases: "].forEach(kelas => {
                        const optionText = `${kelas.tingkat} - ${kelas.jurusan.toUpperCase()}`;
