        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 relative" id="addSoal">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="tipe" class="block mb-2 text-sm font-medium text-gray-900 ">Tipe Soal</label>
                    ...
                    <div class="col-span-2">
                        <label for="pertanyaan" class="block mb-2 text-sm font-medium text-gray-900 ">Pertanyaan Soal</label>
                    ...
                    <div class="col-span-1 pilgan hidden">
                        <label for="pilihan1" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 1</label>
                        <input type="text" id="pilihan1" name="pilihan1"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="pilihan2" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 2</label>
                        <input type="text" id="pilihan2" name="pilihan2"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="pilihan3" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 3</label>
                        <input type="text" id="pilihan3" name="pilihan3"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="pilihan4" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 4</label>
                        <input type="text" id="pilihan4" name="pilihan4"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-2 pilgan hidden">
                        <label for="pilihan5" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 5</label>
                        <input type="text" id="pilihan5" name="pilihan5"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-2">
                        <label for="kunci" class="block mb-2 text-sm font-medium text-gray-900 ">Kunci Jawaban</label>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 relative" id="editSoal">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="edit-tipe" class="block mb-2 text-sm font-medium text-gray-900 ">Tipe Soal</label>
                    ...
                    <div class="col-span-2">
                        <label for="edit-pertanyaan" class="block mb-2 text-sm font-medium text-gray-900 ">Pertanyaan Soal</label>
                        <textarea id="edit-pertanyaan" rows="4" name="pertanyaan"
                            class="form-control block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Pertanyaan" style="height: 55px;"></textarea>
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="edit-pilihan1" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 1</label>
                        <input type="text" id="edit-pilihan1" name="pilihan1"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="edit-pilihan2" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 2</label>
                        <input type="text" id="edit-pilihan2" name="pilihan2"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="edit-pilihan3" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 3</label>
                        <input type="text" id="edit-pilihan3" name="pilihan3"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-1 pilgan hidden">
                        <label for="edit-pilihan4" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 4</label>
                        <input type="text" id="edit-pilihan4" name="pilihan4"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-2 pilgan hidden">
                        <label for="edit-pilihan5" class="block mb-2 text-sm font-medium text-gray-900 ">Pilihan 5</label>
                        <input type="text" id="edit-pilihan5" name="pilihan5"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Link Soal" />
                    </div>
                    <div class="col-span-2">
                        <label for="edit-kunci" class="block mb-2 text-sm font-medium text-gray-900 ">Kunci Jawaban</label>
        ...
        function openEditModal(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    select_api('#edit-IDUjian', '#editSoal', data);
                },
                error: function(errors) {
                    console.error(errors);
                    $('.loading-spinner').addClass('hidden');
