...
@section('content')
    <div class="mb-10 flex justify-between items-center">
        <h1 class="font-bold text-2xl">Courses List</h1>
    ...
    <div id="kursus-edit-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5 relative" id="editCourse">
                    <div
    ...
    <script>
        $(document).ready(function() {
            ...
            function openEditModal(id) {
                $('#editCourse').find('.form-control').prop('disabled', true);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#editCourse').find('.form-control').prop('disabled', false);
